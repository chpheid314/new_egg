import {
  ...
  useRouter,
  useRouterState
} from "./chunk-IPPGIXRE.js";
import "./chunk-PVVRQB55.js";
import {
  require_react
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-ZFWMZBB2.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet2(this, _Component2)) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-WXYILEBS.js"));
